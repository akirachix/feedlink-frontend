   ...
   <div className="flex min-h-screen w-full flex-col md:flex-row">
     <div className="relative w-full md:w-1/2">
       ...
       <div className="relative z-20 flex h-full flex-col items-center justify-center p-6 text-white md:p-8">
         <div className="w-full max-w-[600px] min-h-[400px] flex flex-col justify-center rounded-lg bg-opacity-50 p-6 backdrop-blur-sm shadow-xl md:p-10">
           ...
           <p className="text-medium mb-4 text-center font-medium text-gray-200">
             Create your account, let&apos;s save our planet together.
           </p>
           <h2 className="text-xl font-bold text-white text-center leading-tight md:text-2xl">
     ...
     <div className="w-full bg-[var(--primary-color)] p-6 md:w-1/2 md:flex md:items-center md:justify-center">
       <div className="w-full max-w-md space-y-6">
         <h1 className="text-3xl font-bold text-[var(--secondary-color)] md:text-4xl">Sign Up</h1>
         ...
         <form onSubmit={handleSubmit} className="space-y-6">
           ...
           <div>
             ...
             <input
               ...
               maxLength={6}
             />
             {formErrors.tillNumber && <p className="text-orange-500 text-[15px] mt-1">{formErrors.tillNumber}</p>}
           </div>
           ...
           <button
             type="submit"
             disabled={loading}
             className="w-full py-3 bg-[var(--secondary-color)] text-white font-bold rounded-lg transition duration-200 hover:bg-white hover:text-[var(--secondary-color)] disabled:opacity-70"
           >
